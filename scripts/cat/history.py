...
class History:
    ...
    def __init__(self,
        ...
        self.was_abused = was_abused if was_abused else False
        self.abuser = abuser if abuser else False
        self.abuse_target = abuse_target if abuse_target else []
    ...
    def make_dict(cat):
        history_dict = {
            ...
            "was_abused": cat.history.was_abused,
            "abuser": cat.history.abuser,
            "abuse_target": cat.history.abuse_target
        }
        return history_dict
