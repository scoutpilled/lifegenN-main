...
class History:
    ...
    def add_mentor_skill_influence_strings(cat):
        ...
        skill_influence_text = {
            ...
            SkillPath.ANTHROPOLOGIST: ["studying Twoleg culture"],
            SkillPath.ARCHAEOLOGIST: ["learning from bones"],
            SkillPath.ARCHIVER: ["archiving information"],
            SkillPath.ARRANGER: ["arranging thing"],
            SkillPath.ARTIFICER: ["crafting"],
            ...
            SkillPath.COMEDIAN: ["making jokes"],
            SkillPath.DANCER: ["dancing"],
            SkillPath.DEBATER: ["debating"],
            SkillPath.DECEPTOR: [ "deception" ],
            SkillPath.DISCIPLINE: ["disciplining others"],
            SkillPath.ENFORCER: ["enforcing the law"],
            ...
            SkillPath.FORTITUDE: ["building a stronger constitution"],
            SkillPath.INTIMIDATION: ["intimidating others"],
            SkillPath.INVENTOR: ["inventing"],
            SkillPath.MEDIUM: ["channeling spirits"],
            SkillPath.MENTALIST: ["connecting with others"],
            SkillPath.REPORTER: ["reporting events"],
            SkillPath.MIMICKER: ["mimicking others"],
            SkillPath.MINDFUL: ["being mindful"],
            SkillPath.MOURNER: ["mourning the dead"],
            SkillPath.NEGOTIATOR: ["negotiating"],
            SkillPath.PAINTER: ["painting"],
            SkillPath.PARENTING: ["parenting"],
            SkillPath.PLAYING: ["playing games"],
            SkillPath.PATROLLING: ["patrolling"],
            SkillPath.PSYCHIC: ["developing psychic abilities"],
            SkillPath.POET: ["creating poetry"],
            SkillPath.RESEARCHER: ["conducting research"],
            SkillPath.SCAVENGER: ["scavenging"],
            SkillPath.SCHEMER: ["scheming"],
            SkillPath.SCOUTER: ["scouting"],
            SkillPath.SCRIBE: ["scribing"],
            SkillPath.STARLESS: ["sympathizing with starless cats"],
            SkillPath.STEALTH: ["stealthing"],
            SkillPath.STRATEGIST: ["strategizing"],
            SkillPath.STYLIST: ["stylizing"],
            SkillPath.SUMMONER: ["summoning spirits"],
            SkillPath.TAMER: ["taming"],
            SkillPath.THIEF: ["stealing"],
            SkillPath.TRADER: ["trading"],
            SkillPath.VISION: ["interpreting visions"],
            SkillPath.WEATHER: ["weather reporting"],
            SkillPath.WEAVER: ["weaving"],

            SkillPath.AURA: ["aura reading"],
            SkillPath.ADVOCATE: ["advocating for others"],
            SkillPath.ASSASSIN: ["assassination strategies"],
            SkillPath.CHAMPION: ["championship"],
            SkillPath.COMMANDER: ["commanding others"],
            SkillPath.COMPULSION: ["compelling others"],
            SkillPath.CURSED: ["using cursed abilities"],
            SkillPath.DEATH: ["sensing death"],
            SkillPath.ENTERTAINER: ["entertaining others"],
            SkillPath.FAIRY: ["dealing with fairies"],
            SkillPath.ILLUSION: ["crafting illusions"],
            SkillPath.LEGACY: ["upholding legacy"],
            SkillPath.MEDITATION: ["meditating"],
            SkillPath.MINDER: ["minding others"],
            SkillPath.NECROMANCER: ["resurrecting"],
            SkillPath.NURSE: ["nursing"],
            SkillPath.ORATOR: ["orating"],
            SkillPath.PLANNER: ["planning"],
            SkillPath.POSSESSED: ["possessed abilities"],
            SkillPath.PREACHER: ["preaching"],
            SkillPath.PROJECTION: ["projecting emotions"],
            SkillPath.RANGER: ["ranging attacks"],
            SkillPath.RECOVERER: ["quickly recovering"],
            SkillPath.REINCARNATED: [ "reincarnated abilities"],
            SkillPath.RISEN: ["bringing back the dead"],
            SkillPath.RITE: ["upholding rituals"],
            SkillPath.SIREN: ["singing"],
            SkillPath.SPY: ["spying"],
            SkillPath.TELEPATHIC: [ "using non-vocal communication"],
            SkillPath.TESTER: ["testing things"],
            ...
            SkillPath.GUARD: ["safety guarding"],
            ...
            SkillPath.MYTHOLOGICAL: ["growing mythological reputation"],
            SkillPath.LEARNER: ["learning"],
            SkillPath.COMPETITOR: ["competing"],
            SkillPath.CHALLENGER: ["challenging others"],
            SkillPath.BEHAVIORIST: ["studying behavioral quirks"],
            SkillPath.HAUNTED: ["connecting with the supernatural"],
            SkillPath.RESURRECTED: ["recalling the past"],

            SkillPath.PROJECTOR: ["projecting conciousness"],
            SkillPath.RETRIEVER: ["retrieving energy"],
            SkillPath.EXTRACTOR: ["refocusing energy"],
            SkillPath.PURIFIER: ["cleansing emotions"],
            SkillPath.TRANCER: ["going into trances"],
            SkillPath.DIVINER: ["divining futures"],
            }
