...
class Pelt:
    ...
    physical_trait_teeth = ['TEETHOVERBITE', 'TEETHUNDERBITE']
    physical_trait_ear = ['EARSMALL', 'EARBIG', 'FOLDBOTH', 'FOLDONE', 'EARKOALA', 'EARWING', 'EARDROOPY', 'EARLOP', 'EARCURL']
    physical_trait_headfur = ['HEADSIDEPART', 'HEADCOWLICK', 'HEADAHOGE', 'HEADMOHAWK', 'HEADAFRO', 'HEADBANGS', 'HEADGLACEONHAIR', 'HEADWOOLOO', 'HEADALOLEANVULPIX']
    physical_trait_cheekfur = ['CHEEKLONG', 'CHEEKFLUFF', 'CHEEKCURL', 'CHEEKSIDEBURNS', 'CHEEKSPIKY']
    physical_trait_mane = ['MANEAARDWOLF', 'MANELION', 'MANESUN', 'MANETRICERATOPS', 'MANEDUBWOOL', 'MANEFLOWER', 'MANECLOUD', 'MANEPINECONE', 'MANECOBRA', 'MANEHEART']
    physical_trait_muzzle_type = ['MUZZLESHORT', 'MUZZLEBROAD', 'MUZZLELONG']
    physical_trait_tail = ['TAILCROOKED', 'TAILLONG', 'TAILFEATHER', 'TAILCURL', 'TAILTUFT', 'TAILSQUIRREL', 'TAILBUNNY', 'TAILSKUNK', 'TAILFLAME', 'TAILLEAF', 'TAILCLOUD']
    physical_trait_misc = ['EARTUFTS', 'POLYDACTYL', 'SHOULDERWINGS', 'LEGWINGS', 'ARMPITFLOOF', 'LEGWARMERS', 'FURRYMITTENS']
    ...
    def __init__(self,
        ...
        self.fur_texture = fur_texture if fur_texture is not None else choice(["soft", "curly", "rough", "silky", "sleek", "wavy", "sparse", "tangled", "fuzzy", "spiky", "poofy"])
        self.build = build if build is not None else choice(["stocky", "slender", "lithe", "wiry", "muscular", "lanky", "delicate", "plump"])
