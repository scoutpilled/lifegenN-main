...
class MakeClanScreen(Screens):
    ...
    def handle_choose_background_event(self, event):
        if event.ui_element == self.elements['previous_step']:
            ...
            self.selected_camp_tab = 1
            self.refresh_text_and_buttons()
        elif event.ui_element == self.elements["rainworld_biome"]:
            self.biome_selected = "Rainworld"
            self.selected_camp_tab = 1
            self.refresh_text_and_buttons()
        elif event.ui_element == self.elements["desert_biome"]:
            self.biome_selected = "Desert"
            self.selected_camp_tab = 1
            self.refresh_text_and_buttons()
        elif event.ui_element == self.elements["wetlands_biome"]:
            self.biome_selected = "Wetlands"
            self.selected_camp_tab = 1
            self.refresh_text_and_buttons()
            ...
            possible_biomes = ['Forest', 'Mountainous', 'Plains', 'Beach', 'Rainworld', 'Desert', 'Wetlands']
    ...
    def refresh_selected_camp(self):
        ...
        if self.biome_selected == 'Forest':
            ...
            self.tabs["tab3"] = UIImageButton(scale(pygame.Rect((190, 500), (308, 60))), "", object_id="#grotto_tab"
                                              , manager=MANAGER)
            self.tabs["tab4"] = UIImageButton(scale(pygame.Rect((170, 570), (308, 60))), "", object_id="#pine_tab"
                                              , manager=MANAGER)
            self.tabs["tab5"] = UIImageButton(scale(pygame.Rect((170, 640), (308, 60))), "", object_id="#birch_camp_tab"
                                              , manager=MANAGER)
        elif self.biome_selected == 'Mountainous':
            ...
            self.tabs["tab4"] = UIImageButton(scale(pygame.Rect((128, 570), (308, 60))), "", object_id="#taiga_camp_tab"
                                              , manager=MANAGER)
            self.tabs["tab5"] = UIImageButton(scale(pygame.Rect((118, 640), (308, 60))), "", object_id="#city_tab"
                                              , manager=MANAGER)
        elif self.biome_selected == 'Beach':
            ...
            self.tabs["tab1"] = UIImageButton(scale(pygame.Rect((78, 360), (308, 60))), "", object_id="#npouter_camp_tab"
                                              , manager=MANAGER)
        elif self.biome_selected == 'Desert':
            self.tabs["tab1"] = UIImageButton(scale(pygame.Rect((128, 360), (308, 60))), "", object_id="#abandonedtwolegdesert_tab"
                                              , manager=MANAGER)
        elif self.biome_selected == 'Wetlands':
            self.tabs["tab1"] = UIImageButton(scale(pygame.Rect((128, 360), (308, 60))), "", object_id="#lakeside_tab"
                                              , manager=MANAGER)
    ...
    def randomize_custom_cat(self):
        ...
        self.tint=choice(["pink", "gray", "red", "orange", "black", "yellow", "purple", "blue", "dilute", "warmdilute", "cooldilute", "offwhite", "cream", "darkcream", "darkgray", "lightpink", "lightblack", "trueblack"]) if random.randint(1,5) == 1 else None
        self.skin=choice(Pelt.skin_sprites)
        self.white_patches_tint=choice(["offwhite", "cream", "darkcream", "gray", "pink", "red", "orange", "black", "lightblack", "blackish", "darkgray", "yellow", "purple", "blue"]) if random.randint(1,5) == 1 else None
        ...
        self.accessory = choice(Pelt.plant_accessories + Pelt.np_autism + Pelt.wild_accessories + Pelt.collars + Pelt.flower_accessories + Pelt.plant2_accessories + Pelt.snake_accessories + Pelt.smallAnimal_accessories + Pelt.deadInsect_accessories + Pelt.aliveInsect_accessories + Pelt.fruit_accessories + Pelt.crafted_accessories + Pelt.tail2_accessories) if random.randint(1,3) == 1 else None
    ...
    # values are ((x position, y position), (x width, y height))
        ...
        if self.page == 0:
            ...
            if self.tint:
                self.elements['tint'] = pygame_gui.elements.UIDropDownMenu(["None"] + ["pink", "gray", "red", "orange", "black", "yellow", "purple", "blue", "dilute", "warmdilute", "cooldilute", "offwhite", "cream", "darkcream", "darkgray", "lightpink", "lightblack", "trueblack"], str(self.tint), scale(pygame.Rect((column4_x, y_pos[2]), (250, 70))), manager=MANAGER)
            else:
                self.elements['tint'] = pygame_gui.elements.UIDropDownMenu(["None"] + ["pink", "gray", "red", "orange", "black", "yellow", "purple", "blue", "dilute", "warmdilute", "cooldilute", "offwhite", "cream", "darkcream", "darkgray", "lightpink", "lightblack", "trueblack"], "None", scale(pygame.Rect((column4_x, y_pos[2]), (250, 70))), manager=MANAGER)
            ...
            if self.white_patches_tint:
                self.elements['white_patches_tint'] = pygame_gui.elements.UIDropDownMenu(["None"] + ["offwhite", "cream", "darkcream", "gray", "pink", "red", "orange", "lightblack", "black", "blackish", "darkgray", "yellow", "purple", "blue"], str(self.white_patches_tint), scale(pygame.Rect((column4_x, y_pos[6]), (250, 70))), manager=MANAGER)
            else:
                self.elements['white_patches_tint'] = pygame_gui.elements.UIDropDownMenu(["None"] + ["offwhite", "cream", "darkcream", "gray", "pink", "red", "orange", "lightblack", "black", "blackish", "darkgray", "yellow", "purple", "blue"], "None", scale(pygame.Rect((column4_x, y_pos[6]), (250, 70))), manager=MANAGER)
        ...
        #tortie pattern2
            ...
            if self.accessory:
                self.elements['accessory'] = pygame_gui.elements.UIDropDownMenu(["None"] + Pelt.np_autism + Pelt.plant_accessories + Pelt.wild_accessories + Pelt.collars + Pelt.flower_accessories + Pelt.plant2_accessories + Pelt.snake_accessories + Pelt.smallAnimal_accessories + Pelt.deadInsect_accessories + Pelt.aliveInsect_accessories + Pelt.fruit_accessories + Pelt.crafted_accessories + Pelt.tail2_accessories, str(self.accessory), scale(pygame.Rect((1150, y_pos[2]), (300, 70))), manager=MANAGER)
            else:
            ...
            if self.permanent_condition:
                self.elements['permanent conditions'] = pygame_gui.elements.UIDropDownMenu(
                    ["None"] + permanent_conditions, str(self.permanent_condition), scale(pygame.Rect((1150, y_pos[4]), (300, 70))), 
                    manager=MANAGER)
            else:
                self.elements['permanent conditions'] = pygame_gui.elements.UIDropDownMenu(
                    ["None"] + permanent_conditions, "None", scale(pygame.Rect((1150, y_pos[4]), (300, 70))), manager=MANAGER)
    ...
    def open_choose_background(self):
        ...
        # NEON PINK EXCLUSIVE BIOMES
        self.elements["rainworld_biome"] = UIImageButton(
            scale(pygame.Rect((1400, 247), (86, 86))),
            "",
            object_id="#rainworld_biome_button",
            manager=MANAGER,
        )
        self.elements["desert_biome"] = UIImageButton(
            scale(pygame.Rect((790, 255), (94, 72))),
            "",
            object_id="#desert_biome_button",
            manager=MANAGER,
        )
        self.elements["wetlands_biome"] = UIImageButton(
            scale(pygame.Rect((900, 260), (76, 68))),
            "",
            object_id="#wetlands_biome_button",
            manager=MANAGER,
        )
